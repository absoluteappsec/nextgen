...
print()
print("NOTE: Cross-region inference profiles (us.anthropic.*) do not")
print("support prompt caching — requests route across regions, making")
print("per-region KV caching impossible. To see live cache metrics,")
print("use a single-region model ID or the direct Anthropic API.")
print("The cache_control structure here is production-correct.")
print("=" * 60)
